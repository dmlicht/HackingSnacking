...
def get_rating(name):
    ...
    command = 'python search.py --consumer_key="sPXjoKQ5TGRuP8O0VWW_0Q" --consumer_secret="28TsVhiznWyd9BdBiQGOsxKzSSY" --token="zJ6rk5-5Uk0ObRxI-fB7c9vqq7e1iiPb" --token_secret="uCzsZqjbUmOdMoiyyJ55-anlH9U" --term="' + name + '" --location="New York, NY" --limit=5'
